...
* You can now exclude channels, roles and categories from xp in Leveling
* Added the slash command \`ping\` in user apps
...
*No bug fixes were introduced yet*
...
* All "Current Setting(s)" sections have been migrated to embed fields
